...
# Sound
sound_placeholder = st.markdown("", unsafe_allow_html=True)
...
def show_intro_page():
    st.title("Summerlympics")

    st.markdown(
        """
        **Welcome to the ultimate entertainment experience—your new favorite game!**

        Gather two teams, choose up to 15 mini-games, and prepare for an unforgettable day of fun and friendly competition. 
        The rules are simple: the points for winning a game match the game’s index number.  
        This keeps the excitement alive until the very last round—no early victories here!  

        So, rally your teams, grab some drinks, and get ready for an epic showdown.  
    ...
    st.caption("Choose your playing mode and relive epic battles from the past!")
    hof_games = {
        'Cretelympics 2025': {
            'game_name': 'Cretelympics',
            'P1': 'Powerwomen',
            'P2': 'Auberginators',
            'color_background': '#1E90FF',
            'color_text': '#FFFFFF',
            'song': 'Erinner mich',
            'P1_avatar': '🥥',
            'P2_avatar': '🍆',
